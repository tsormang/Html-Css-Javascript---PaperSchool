...
$(document).ready(function () {
    $("#questionmark2").click(function (e) {
        ...
        var tip = $("#tip2");
        tip.animate({ top: '-910px' }, "fast");
    });

    $("#tip2").hover(function (e) {
        var tipbubble = $("#tipbubble2");
        tipbubble.css({ top: '-950px' });
    });
...
// Snow function By Zachary Johnson
(function ($) {
    ...
    $("#footerClick").click(function (e) {
        ...
        snowpile3.animate({ bottom: '-220px' }, 12000);
        snowpile4.animate({ bottom: '-300px' }, 11000);

        //Change the parallax images
        $(".image9").attr("src", "Images/snow1.png");
        $(".image8").attr("src", "Images/snow2.png");
