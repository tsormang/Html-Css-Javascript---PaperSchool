...
$(document).ready(function () {
    ...
    $("#btnRefresh").on({
        'click': function () {
            ...
            $("#myTableS tbody").append("<tr id='" + (CounterSC + 2) + "'><td> " + (CounterSC + 2) + " </td><td>" + StuFirstName3 + "</td><td>" + StuLastName3 + "</td><td><ol> <li>" + CourseTitle1 + "</li><li>" + CourseTitle2 + "</li> </ol></td><td><img class='btnDelete' src='Images/delete.png'/><img class='btnEdit' src='Images/edit.png'/></td></tr>");
