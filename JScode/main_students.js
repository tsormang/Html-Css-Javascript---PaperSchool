$(document).ready(function () {
    ...
    $("#myForm").validate({
        rules: {
            ...
            TuitionFees: { required: true, number: true },
            sex: { required: true }
        },
        messages: {
            FirstName: { required: "Guess a Name, type at least something!", minlength: "Basic Math, Count to 5, place at least 5 characters!" },
            LastName: { required: "Its not Rocket Science, type at least something!", minlength: "C'mon, place at least 5 characters!" },
            TuitionFees: { required: "Easy ... , type at least something!", number: "'A' This ...is ...a ... letter, '2' this ... is .. a ... number!" },
